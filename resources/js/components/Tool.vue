...
export default {
    ...
    async created() {
        ...
        if (localStorage.getItem('file-manager-view')) {
            let viewS = localStorage.getItem('file-manager-view');
            if (['grid', 'list'].includes(viewS)) {
                this.view = viewS;
            } else {
                localStorage.setItem('file-manager-view', 'grid');
            }
        }
    ...
    methods: {
        ...
        viewAs(type) {
            this.view = type;
            localStorage.setItem('file-manager-view', type);
        },
